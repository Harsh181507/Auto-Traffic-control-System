...
class Vehicle(pygame.sprite.Sprite):
    def __init__(self, lane, vehicleClass, direction_number, direction, will_turn):
        ...
        pathb ='down/bike.png'
        pathbus ='down/bus.png'
        pathbike = 'down/car.png'
        self.originalImage = pygame.image.load(pathb)
        self.currentImage = pygame.image.load(pathb)
        self.originalImage = pygame.image.load(pathbus)
        self.currentImage = pygame.image.load(pathbus)
        self.originalImage = pygame.image.load(pathbike)
        self.currentImage = pygame.image.load(pathbike)
